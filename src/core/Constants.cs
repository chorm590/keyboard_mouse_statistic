...
namespace KMS.src.core
{
    static class Constants
    {
        ...
        {
            new Keys(0x00,"",""),
            new Keys(0x01,     "Left mouse button",                "鼠标左键"),
            new Keys(0x02,     "Right mouse button",               "鼠标右键"),
            new Keys(0x03,     "Control-break processing",         "vk_cancel"),
            new Keys(0x04,     "Middle mouse button",              "鼠标中键"),
            new Keys(0x05,     "X1 mouse button",                  "x1_key"),
            new Keys(0x06,     "X2 mouse button",                  "x2_key"),
            new Keys(0x07,"",""),
